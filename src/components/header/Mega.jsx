...
export const getCategoriesData = async () => {
    const res = await fetch('http://localhost:3000/api/categorytitlesubcategorylist');
...
export default async function Mega({ staticMenuClass }) {
  // const result=await getCategoriesData()
  // console.log('result=>',result);
  // const staticMenuClass=true
  return (
    <>
      <div id="mega-menu">
        <a
            ...
            <div className="drop-menu d-flex justify-content-between">
              <div className="one-third">
                ...
                <ul className="ps-0 mb40">
                  ...
                  <li>
                    <Link href="/">Landing Page Design</Link>fafaf
                  </li>
                  <li>
